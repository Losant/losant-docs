...
If interested, this builder kit has another set of <a href="/getting-started/losant-iot-dev-kits/builder-kit/" target="_blank">instructions</a>. The environment setup is longer, but you will be able to rewrite and re-flash the device yourself.
