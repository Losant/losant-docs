...
* 1 [Adafruit Feather Huzzah](https://www.adafruit.com/products/2821) development board
...
For this workshop, you’ll need to attach the AdaFruit Feather Huzzah and button to the breadboard. Below is the wiring diagram.
...
1. Connect the rightmost lead (c25) of the temperature sensor to the negative rail using a resistor at c25.
